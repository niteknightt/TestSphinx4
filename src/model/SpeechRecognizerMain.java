...
public class SpeechRecognizerMain {
	...
	public SpeechRecognizerMain() {
		...
		// Grammar
		configuration.setGrammarPath("/Users/il015650/git/TestJavaProject/MyTestProject/resources/grammars");
					...
					while (speechRecognizerThreadRunning) {
						...
						if (!ignoreSpeechRecognitionResults) {
							...
							if (speechResult == null)
								...
								Collection<String> nbest = speechResult.getNbest(10);
								for (String option : nbest) {
